...
axs[0, 0].scatter(df['NILS conc (ppm)'].to_numpy(), df['Volume'].to_numpy(), s = 0.5, color = 'blue')
axs[0, 0].scatter(highclgrain['NILS conc (ppm)'].to_numpy(), highclgrain['Volume'].to_numpy(),s = 0.5, color = 'red')
axs[0, 1].scatter(df['NILS conc (ppm)'].to_numpy(), df['Surface Area'].to_numpy(), s = 0.5, color = 'blue')
axs[0, 1].scatter(highclgrain['NILS conc (ppm)'].to_numpy(), highclgrain['Surface Area'].to_numpy(),s = 0.5, color = 'red')
axs[1, 0].scatter(df['NILS conc (ppm)'].to_numpy(), df['Faces'].to_numpy(), s = 0.5, color = 'blue')
axs[1, 0].scatter(highclgrain['NILS conc (ppm)'].to_numpy(), highclgrain['Faces'].to_numpy(),s = 0.5, color = 'red')
